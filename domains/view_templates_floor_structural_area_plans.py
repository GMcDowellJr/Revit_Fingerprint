# -*- coding: utf-8 -*-
"""
View Templates - Floor Plans, Structural Plans, and Area Plans domain extractor.

Domain family: view_templates
Contains view types: FloorPlan, AreaPlan (ViewType integers: 1, 117)
...
No VCO/category-override machinery — that belongs in view_category_overrides domain.
"""
