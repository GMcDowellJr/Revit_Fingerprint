# -*- coding: utf-8 -*-
"""
Dimension Types - Radial domain extractor.

Fingerprints Radial dimension types.

Domain family: dimension_types
Contains shapes: Radial
...
from core.rows import first_param, _as_string, _as_double, _as_int
...
_HANDLED_SHAPES = frozenset({SHAPE_RADIAL})

# Family name expected for user-governed types in this domain
EXPECTED_FAMILY = "Radial Dimension Style"
