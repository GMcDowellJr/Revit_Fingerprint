# -*- coding: utf-8 -*-
"""
Fill Patterns (Drafting) domain extractor.

Fingerprints fill pattern definitions including:
- Solid vs. patterned
- Drafting patterns only
...
_TARGET_INT = 0  # Drafting=0, Model=1
    ...
    try:
        col = list(
            collect_instances(
                ...
                cache_key="fill_patterns_drafting:FillPatternElement:instances",
            )
        )
