# -*- coding: utf-8 -*-
"""
Dimension Types - Linear domain extractor.

Fingerprints Linear and LinearFixed dimension types, including ArcLength
(angular-family but shares linear identity model: witness_line_control).

Domain family: dimension_types
Contains shapes: Linear, LinearFixed, ArcLength
...
from core.rows import first_param, _as_string, _as_double, _as_int, format_len_inches
...
# Shapes handled by this domain: Linear, LinearFixed (linear family), ArcLength (angular family
