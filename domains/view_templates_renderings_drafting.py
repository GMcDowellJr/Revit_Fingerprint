# -*- coding: utf-8 -*-
"""
View Templates domain extractor - Renderings, Drafting Views, and Drawings.

Filters to only process view templates whose ViewType is one of:
  Rendering, DraftingView, Drawing
...
_HANDLED_VIEW_TYPES = frozenset({"Rendering", "DraftingView", "Drawing"})


def extract(doc, ctx=None):
    """
    Extract view templates fingerprint - Renderings, Drafting Views, Drawings only.
    ...
    for v in col:
        ...
        # Check ViewType filter - only process Rendering, DraftingView, Drawing
        try:
        ...
        # -----------------------------------------
        # NON-SCHEDULE templates (Rendering/DraftingView/Drawing are never schedules)
        # -----------------------------------------
        sig = []
