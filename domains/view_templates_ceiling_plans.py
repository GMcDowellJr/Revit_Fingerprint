# -*- coding: utf-8 -*-
"""
View Templates domain extractor - Ceiling Plans.

Filters to only process view templates whose ViewType is:
  CeilingPlan
...
def extract(doc, ctx=None):
    ...
    for v in col:
        ...
        # Check ViewType filter - only process CeilingPlan
        try:
        ...
        # -----------------------------------------
        # NON-SCHEDULE templates (CeilingPlan is never a schedule)
        # -----------------------------------------
        sig = []
