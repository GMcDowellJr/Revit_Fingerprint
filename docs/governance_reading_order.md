...
See `docs/governance_interpretation_guide.md`'s "What this package is for"
...
Two known-bad-inference entries in `docs/governance_interpretation_guide.md`
...
2. **Evidence map / interpretation guide orientation** —
   ...
   `docs/governance_interpretation_guide.md` (what the metrics and tiers
...
5. **Narrative prose** — `governance_narrative_context.md`, the
   ...
   framing.
6. **Question routes** — `docs/governance_question_routes.md`, if there is
