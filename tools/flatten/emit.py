...
def emit_flatten(exports_dir: Path, out_dir: Path, file_id_mode: str = "basename") -> Tuple[List[Dict[str, str]], List[Dict[str, str]]]:
...
def emit_analysis(meta_rows: List[Dict[str, str]], records: List[Dict[str, str]], out_dir: Path) -> str:
    ...
    if _label_synth_active:
        _phase0_dir = out_dir.parent / "flatten"
    ...
    _write_csv(out_dir / "authority_pattern.csv", [
