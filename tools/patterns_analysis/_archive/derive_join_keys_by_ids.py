# tools/patterns_analysis/derive_join_keys_by_ids.py
...
from tools.patterns_analysis.domain_identity_contract import DomainIdentityContract
...
def derive_join_keys_by_ids(
    ...
    *,
    ...
    if phase0_dir:
        # CSV mode: load records+identity from results/records/
