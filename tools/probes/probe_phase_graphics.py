...
_reflection_records_0 = _run_reflection_sweep(selected_views, "View", "phase_graphics")
...
if write_json:
    try:
        ...
        with open(target_path, "w") as f:
            json.dump(_probe_wrap("phase_graphics", OUT_payload), f, indent=2, sort_keys=True)
