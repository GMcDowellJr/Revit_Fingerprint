...
|---|---|---|
| `tools/archetype/vfd_bip_target_domain_hints.json` | vfd bip target domain hints | `unknown` |
| `tools/archetype/vfd_category_domain_map.json` | vfd category domain map | `unknown` |
